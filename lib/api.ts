...
export async function chatWithBase(request: ChatRequest): Promise<ChatResponse> {
...
export async function chatWithFineTuned(request: ChatRequest): Promise<ChatResponse> {
...
export async function solveMath(
  ...
  return modelType === "base" ? chatWithBase(request) : chatWithFineTuned(request);
}
